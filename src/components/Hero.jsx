      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Hi, I'm <span className="text-purple">DU Madumali</span>
          </h1>
          ...
          <div className="flex space-x-4">
            <a
              href="#projects"
              className="px-6 py-3 bg-purple rounded-lg font-medium hover:bg-purple2 transition duration-300"
            >
              View Work
            </a>
            <a
              href="#contact"
              className="px-6 py-3 rounded-lg font-medium border border-purple2 hover:bg-purple/20 transition duration-300"
            >
              Contact Me
            </a>
          </div>
